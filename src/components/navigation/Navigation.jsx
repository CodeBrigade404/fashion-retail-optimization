...
function Navigation() {
  ...
  return (
    <nav className="rounded-lg bg-white rounded-xl ml-2 my-4 drop-shadow-lg w-28 flex flex-col  fixed ">
      <svg
        className="mt-8 "
      ...
      <NavLink
        className={` mt-16 transition-colors rounded-xl duration-1000 ease-out flex h-28 place-content-center ${
      ...
      <NavLink
        className={` transition-colors rounded-xl duration-1000 ease-out flex h-28 place-content-center mb-2 ${
