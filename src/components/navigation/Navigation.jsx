...
function Navigation() {
  ...
  return (
    <nav className="bg-[#04062c] w-28 h-screen flex flex-col  fixed ">
      <svg
        className="mt-8 "
      ...
      <NavLink
        className={` mt-48 transition-all duration-700 ease-linear flex h-28 place-content-center ${
          isNavLinkActive("/") ? "bg-[#EDEDFF]" : ""
        }`}
        to={"/"}
      >
        <svg
        ...
        >
          <path
            fill={`${isNavLinkActive("/") ? "#04062c" : "white"}`}
      ...
      <NavLink
        className={` transition-all duration-700 ease-linear flex h-28 place-content-center ${
          isNavLinkActive("/demand") ? "bg-[#EDEDFF]" : ""
        }`}
        to={"/demand"}
      >
        <svg
        ...
        >
          <path
            fill={`${isNavLinkActive("/demand") ? "#04062c" : "white"}`}
      ...
      <NavLink
        className={`transition-all duration-700 ease-linear  flex h-28 place-content-center ${
          isNavLinkActive("/profit") ? "bg-[#EDEDFF]" : ""
        }`}
        to={"/profit"}
      >
        <svg
        ...
        >
          <path
            fill={`${isNavLinkActive("/profit") ? "#04062c" : "white"}`}
      ...
      <NavLink
        className={` transition-all duration-700 ease-linear flex h-28 place-content-center ${
          isNavLinkActive("/manufacturer") ? "bg-[#EDEDFF]" : ""
        }`}
        to={"/manufacturer"}
      >
        <svg
        ...
        >
          <path
            fill={`${isNavLinkActive("/manufacturer") ? "#04062c" : "white"}`}
      ...
      <NavLink
        className={` transition-all duration-700 ease-linear flex h-28 place-content-center ${
          isNavLinkActive("/stock") ? "bg-[#EDEDFF]" : ""
        }`}
        to={"/stock"}
      >
        <svg
        ...
        >
          <path
            fill={`${isNavLinkActive("/stock") ? "#04062c" : "white"}`}
